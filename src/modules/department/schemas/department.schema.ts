...
export class Department {
  ...
  @ApiProperty({
    description: 'Department patient capacity',
    example: 100,
    required: true,
  })
  @Prop()
  ...
  @ApiProperty({
    description: 'Department clinic collection ID',
  ...
  @ApiProperty({
    description: 'Department required staff',
  ...
  @ApiProperty({
    description: 'Department specializations',
