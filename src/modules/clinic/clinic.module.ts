...
import { Specialization,SpecializationSchema } from '../specialization/schemas/specialization.schema';
import { SpecializationModule } from '../specialization/specialization.module';
@Module({
  imports: [MongooseModule.forFeature([{ name: Clinic.name, schema: ClinicSchema }, { name: 'Appointment', schema: AppointmentSchema },{ name: MedicalRecord.name, schema: MedicalRecordSchema },
